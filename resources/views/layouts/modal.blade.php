    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form name="form_add" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                        <input type='file' name="file" onchange="readURL(this);" ng-model="users.images" multiple ng-files="getTheFiles($files)"  />
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary" ng-click="uploadFiles()" ng-disabled="form_add.$invalid">Lưu</button>
            </div>
        </div><!-- /.modal-content -->
</div><!-- /.modal-dialog -->
</div><!-- /.modal -->