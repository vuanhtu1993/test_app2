                ...
                <form name="form_add" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span id="helpBlock2" class="help-block" ng-show="form_add.age.$error.required && form_add.age.$touched">Age must be required!</span>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <span  class="help-block" ng-show="form_add.address.$error.required && form_add.address.$touched">Adress must be required!</span >
